...
@app.route('/')
def home():
    return "Bot @PINKTIGERV1_BOT aktif 24 jam!"
...
# === KONFIGURASI BOT ===
TOKEN = "7597824604:AAG90X2cslreUewg_eW15SWNEsBTtCyL0bY"
ADMIN_IDS = [6298089884, 5397964203, 1899095326,1580671282,5376362268]
MAKS_IZIN = 5
...
def main():
    ...
    print("✅ BOT AKTIF: @PINKTIGERV1_BOT dengan fitur izin + auto-in + denda")
    keep_alive()
    app_bot.run_polling()
